...
this.level = level;
    ...
    public double getKey(){return calculateKey();}

    public void setPokemons(PokemonList pokemons) {
        this.pokemons = pokemons;
    }

    public void setRibbons(ArrayList<Ribbon> ribbons) {
        this.ribbons = ribbons;
    }
    public void setLeft(Account leftChild){
        this.left = leftChild;
    }
    public void setRight(Account rightChild){
